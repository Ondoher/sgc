...
function outputTile()
{
	...
	console.log('.' +  name + ' .highlight:after {content: ""; position: absolute; left:0; right: 0; width: ' + width + 'px; height: ' + height + 'px; background-image: url("/sgc-module/pages/mj/assets/images/tilesets/' + name + '/highlight.png")}');
}
...
function outputNFaces(start, n, image)
{
	...
	for (var idx = start, stop = idx + n; idx < stop; idx++)
		console.log('.' +  name + ' .face-' + idx + ' {background-image: url("/sgc-module/pages/mj/assets/images/tilesets/' + name + '/' + image + '")}');
